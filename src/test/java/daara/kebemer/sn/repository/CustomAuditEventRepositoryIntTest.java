...
import daara.kebemer.sn.config.audit.AuditEventConverter;
import daara.kebemer.sn.domain.PersistentAuditEvent;
...
import static daara.kebemer.sn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
