...
import { NiveauDialogComponent } from '../../../../../../main/webapp/app/entities/niveau/niveau-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('Niveau Management Dialog Component', () => {
        let comp: NiveauDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(NiveauDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'niveauListModification', content: 'OK'});
